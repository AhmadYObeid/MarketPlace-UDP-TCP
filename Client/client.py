...
def user_registration(request_number):
  ...
  is_registered = True
  user_name = name #TODO: only a temporary solution for now, eventually we should wait for the server's response to set this value to true.
  return msg
...
def looking_for(reqeuest_number):
  if (is_registered == True):
    name = user_name
    #TODO: potentially replace this with a variable that holds the name of
